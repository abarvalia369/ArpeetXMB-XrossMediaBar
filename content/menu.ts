  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        iconKey: "soundcloud",
        panelKey: "soundcloud",
        // NOTE: this points at a specific playlist, not "Likes" — SoundCloud's
        // public embed widget doesn't support Likes as an embeddable resource
        // (verified against their oEmbed API: a /likes URL just resolves back
        // to the general profile widget, not a liked-tracks collection). See
        // the chat for how to actually get a Likes-based embed here.
        embedUrl:
